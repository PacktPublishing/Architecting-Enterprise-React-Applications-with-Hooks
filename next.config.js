module.exports = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/checkpoint-2.7",
        destination:
          "https://github.com/PacktPublishing/Architecting-Enterprise-React-Applications-with-Hooks/compare/Checkpoint_2.7%5E..Checkpoint_2.7",
        permanent: true,
      },
      {
        source: "/checkpoint-2.8",
        destination:
          "https://github.com/PacktPublishing/Architecting-Enterprise-React-Applications-with-Hooks/compare/Checkpoint_2.8%5E..Checkpoint_2.8",
        permanent: true,
      },
      {
        source: "/checkpoint-2.9",
        destination:
      ...
      },
      {
        ...
        destination:
          "https://github.com/PacktPublishing/Architecting-Enterprise-React-Applications-with-Hooks/blob/Checkpoint_3.0/components/TodoInput.jsx#L29-L54",
        permanent: true,
      },
      {
        source: "/checkpoint-3.1",
        destination:
          "https://github.com/PacktPublishing/Architecting-Enterprise-React-Applications-with-Hooks/compare/Checkpoint_3.1%5E%5E%5E%5E..Checkpoint_3.1",
        permanent: true,
      },
      {
        source: "/checkpoint-3.2",
        destination:
          "https://github.com/PacktPublishing/Architecting-Enterprise-React-Applications-with-Hooks/compare/Checkpoint_3.2%5E%5E..Checkpoint_3.2",
        permanent: true,
      },
      {
